...
const defaultFooterText = '〤 vivian 〤';

const tracks = [
    { title: "Destroy Lonely - if looks could kill", path: "assets/music/iflookscouldkill.mp3", geniusId: "8482044" },
    { title: "Ken Carson - Succubus", path: "assets/music/Succubus.mp3", geniusId: "9615170" },
    { title: "Don Toliver - Bandit", path: "assets/music/Bandit.mp3", geniusId: "9610573" },
    { title: "Yeat - Shade", path: "assets/music/Shade.mp3", geniusId: "10059086" },
    { title: "che x SEMATARY - 666", path: "assets/music/666.mp3", geniusId: "9606134" },
    { title: "SGGKobe - thrax", path: "assets/music/thrax.mp3", geniusId: "6498022" },
    { title: "Ndotz - Embrace It", path: "assets/music/EmbraceIt.mp3", geniusId: "10824990" },
    { title: "DJ Scheme - Blue Bills", path: "assets/music/BlueBills.mp3", geniusId: "6145526" },
    { title: "Ken Carson - Green Room", path: "assets/music/GreenRoom.mp3", geniusId: "9615211" },
    { title: "Ken Carson - RICK OWENS", path: "assets/music/RickOwens.mp3", geniusId: "9861465" },
    { title: "Ken Carson - Lose It", path: "assets/music/LoseIt.mp3", geniusId: "9615202" },
    { title: "Anuel AA - LHNA", path: "assets/music/LHNA.mp3", geniusId: "4598848" },
    { title: "Anuel AA - Diamantes en Mis Dientes", path: "assets/music/DiamantesEnMisDientes.mp3", geniusId: "8032687" },
    { title: "$uicideboy$ - Bizarro", path: "assets/music/Bizarro.mp3", geniusId: "5254573" },
    { title: "King Von - 2AM", path: "assets/music/2AM.mp3", geniusId: "5029774" },
    { title: "$uicideboy$ - 1000 Blunts", path: "assets/music/1000Blunts.mp3", geniusId: "8238968" },
    { title: "Yeat - Mountain Climbërs", path: "assets/music/MountainClimbers.mp3", geniusId: "6879161" },
    { title: "Khea x Duki - Loca", path: "assets/music/Loca.mp3", geniusId: "3328979" },
