...
function applyColorsFromImage(imgElement) {
    ...
    try {
        ...
        const textColor = adjustColorBrightness(dominantColorRgb, 65); // Darker text color
        const lighterTextColor = adjustColorBrightness(dominantColorRgb, 85); // Lighter text color
        ...
        const darkenedBackgroundColor = adjustColorBrightness(dominantColorRgb, -70); // Darken by 80%
